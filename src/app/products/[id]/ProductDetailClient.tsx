                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
                        <div className="space-y-8">
                            ...
                            <div className="bg-white/50 backdrop-blur-sm p-6 rounded-[2rem] border border-muted/50 grid grid-cols-2 gap-4">
                                <div className="flex flex-col items-center text-center gap-2 p-3 rounded-2xl hover:bg-white transition-colors">
                                    <BadgeCheck className="text-secondary" size={24} />
                                    <span className="text-[10px] font-bold uppercase tracking-wider text-primary">100% Authentic</span>
                                </div>
                                <div className="flex flex-col items-center text-center gap-2 p-3 rounded-2xl hover:bg-white transition-colors">
                                    <FileText className="text-accent" size={24} />
                                    <span className="text-[10px] font-bold uppercase tracking-wider text-primary">Batch Traceability</span>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            isWishlisted
                                                ...
                                                : "bg-white border-muted text-muted-foreground hover:text-secondary"
                                        )}
                                    >
                                ...
                                <CardContent className="p-8 space-y-8">
                                    ...
                                    <div className="flex items-center justify-between gap-4 pt-6 border-t border-muted/30">
                                        <div className="flex-1">
                                            ...
                                            <div className="flex items-center bg-white rounded-xl p-1 border shadow-inner w-fit">
                                                <Button variant="ghost" size="icon" className="h-9 w-9 rounded-lg hover:bg-secondary/10" onClick={() => setQuantity(q => Math.max(1, q - 1))}>
                                                    <Minus size={14} className="text-primary" />
                                                </Button>
                                                <input type="number" value={quantity} onChange={(e) => setQuantity(Number(e.target.value))} className="w-14 text-center bg-transparent font-bold text-primary border-none outline-none text-sm" />
                                                <Button variant="ghost" size="icon" className="h-9 w-9 rounded-lg hover:bg-secondary/10" onClick={() => setQuantity(q => q + 1)}>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <Button
                                            ...
                                            size="lg"
                                            className="gradient-button text-white rounded-2xl h-14 font-bold text-base group border-none shadow-lg shadow-secondary/10"
                                        >
                                            <ShoppingCart className="mr-2 group-hover:scale-110 transition-transform" size={20} /> Add to Enquiry
                                        </Button>
                                        <Button onClick={handleWhatsAppChat} size="lg" className="bg-[#25D366] hover:bg-[#1DA851] text-white rounded-2xl h-14 font-bold text-base shadow-lg shadow-green-500/10 border-none">
                            ...
                            <div className="bg-white p-8 rounded-[2rem] border border-muted shadow-sm flex flex-col gap-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <div className="flex items-center gap-4 group">
                                        <div className="w-12 h-12 bg-accent/10 rounded-2xl flex items-center justify-center text-accent shrink-0 group-hover:bg-accent group-hover:text-white transition-all"><ThermometerSnowflake size={24} /></div>
                                        <div className="flex-1"><h4 className="font-bold text-sm text-primary leading-tight">Cold Chain</h4><p className="text-[11px] text-muted-foreground leading-tight">Strict temperature controls.</p></div>
                                    </div>
                                    <div className="flex items-center gap-4 group">
                                        <div className="w-12 h-12 bg-secondary/10 rounded-2xl flex items-center justify-center text-secondary shrink-0 group-hover:bg-secondary group-hover:text-white transition-all"><BadgeCheck size={24} /></div>
                                        <div className="flex-1"><h4 className="font-bold text-sm text-primary leading-tight">Authentic Supply</h4><p className="text-[11px] text-muted-foreground leading-tight">Direct from partners.</p></div>
                                    </div>
                                    <div className="flex items-center gap-4 group">
                                        <div className="w-12 h-12 bg-primary/10 rounded-2xl flex items-center justify-center text-primary shrink-0 group-hover:bg-primary group-hover:text-white transition-all"><FileText size={24} /></div>
                                        <div className="flex-1"><h4 className="font-bold text-sm text-primary leading-tight">Traceability</h4><p className="text-[11px] text-muted-foreground leading-tight">Full batch details.</p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
