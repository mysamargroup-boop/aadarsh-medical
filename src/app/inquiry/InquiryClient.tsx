                    ...
                    {!isSubmitted ? (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-5">
                                ...
                                <div className="md:col-span-2 medical-gradient-dark p-8 md:p-12 text-white">
                                    ...
                                    <p className="text-white/80 text-sm leading-relaxed mb-10">
                                        Partner with Adarsh Medical for reliable pharmaceutical distribution. Fill out the form, and our procurement team will contact you within 24 hours.
                                    </p>
                                ...
                                <div className="md:col-span-3 p-8 md:p-12">
                                    <form onSubmit={handleSubmit} className="space-y-6">
                                        <div className="space-y-2">
                                            <Label htmlFor="organization" className="text-xs font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-2">
                                                <Building2 size={14} className="text-secondary" /> Pharmacy / Hospital Name
                                            </Label>
                                            <Input
                                                id="organization"
                                                required
                                                placeholder="Adarsh Health Clinic"
                        ...
                        <div className="bg-white rounded-[2.5rem] border border-muted/30 shadow-2xl p-12 text-center">
                            ...
                            <p className="text-muted-foreground max-w-md mx-auto mb-10 leading-relaxed">
                                Thank you for your interest in Adarsh Medical. Our team is reviewing your requirements and will get back to you shortly.
                            </p>
