...
export default function CollectionDetailClient() {
    ...
    const product = useMemo(() => {
        ...
        // Find product by checking if its ID is at the end of the slug
        // Better: search for a product where the slug matches the expected pattern
        const found = products.find(p => {
            const testUrl = getProductUrl(p);
            return testUrl.endsWith(lastPart);
        });
