      ...
      <header className="fixed top-0 left-0 right-0 z-50">
        ...
        >
          <div className="max-w-7xl mx-auto flex items-center justify-between gap-4 relative">
            <div className="flex items-center md:hidden gap-2 shrink-0 z-20">
              <button
        ...
        {isMobileMenuOpen && (
          <div className="absolute top-full left-0 right-0 bg-white shadow-2xl p-6 flex flex-col gap-4 animate-in slide-in-from-top duration-300 md:hidden border-t border-muted/20">
            ...
            <Button className="w-full bg-primary text-white mt-4 py-6 font-bold rounded-xl shadow-lg">Join Group</Button>
          </div>
        )}
      </header>

      {/* Bottom Navigation for Mobile */}
      <div className="md:hidden fixed bottom-2 left-4 right-4 z-[60] bg-primary/95 backdrop-blur-md rounded-2xl shadow-2xl border border-white/10 p-2.5 flex justify-around items-center">
